  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-12 space-y-12">
      <div className="fade-in text-center sm:text-left">
        <h1 className="text-4xl sm:text-5xl font-display font-bold mb-4 flex flex-wrap items-center justify-center sm:justify-start gap-3">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 fade-in">
        <Card className="p-6 hover-lift cursor-pointer text-center sm:text-left">
          <Trophy className="h-12 w-12 text-secondary mb-4 mx-auto sm:mx-0" />
