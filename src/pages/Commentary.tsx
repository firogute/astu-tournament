...
const Commentary = () => {
  ...
  const [matchStatus, setMatchStatus] = useState<'paused' | 'first_half' | 'second_half'>('paused');
  const [commentary, setCommentary] = useState('');

  const liveMatches = matches.filter(m => m.status !== 'finished');

  const handleStartHalf = (half: 'first_half' | 'second_half') => {
    setMatchStatus(half);
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      {/* Match Selector */}
      <Card className="p-6 mb-8 fade-in">
        <h2 className="text-xl font-display font-bold mb-4">Select Active Match</h2>
      ...
      {selectedMatch && (
        <div className="grid lg:grid-cols-3 gap-8 fade-in">
          ...
          <Card className="p-6 lg:col-span-2">
            <div className="flex items-center justify-between mb-6">
              ...
              >
                {matchStatus === 'paused' ? 'PAUSED' : 
                 matchStatus === 'first_half' ? '1ST HALF' : '2ND HALF'}
              </Badge>
            </div>
            ...
            {/* Commentary Input */}
            <div className="mt-8">
              <h3 className="font-display font-semibold mb-3">Add Text Commentary</h3>
              <Textarea
                value={commentary}
          ...
          {/* Event Timeline */}
          <Card className="p-6">
            <h2 className="text-xl font-display font-bold mb-6">Event Timeline</h2>
